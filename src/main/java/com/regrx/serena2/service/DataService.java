package com.regrx.serena2.service;
...
import com.regrx.serena2.common.network.HistoryDownloader;
import com.regrx.serena2.common.network.PriceDownloader;
import com.regrx.serena2.common.utils.LogUtil;
import com.regrx.serena2.common.utils.PreparationUtil;
import com.regrx.serena2.common.utils.SyncLock;
import com.regrx.serena2.common.utils.TimeUtil;
import com.regrx.serena2.employee.Trader;
import com.regrx.serena2.data.MinutesData;
...
public class DataService implements Runnable {
    ...
    public DataService(String type, IntervalEnum interval, DataServiceManager manager) {
        super();
        this.type = type;
    ...
    private void callback(ExPrice newPrice) {
        if (interval != manager.getMinimumInterval()) {
            return;
        }
        ...
        synchronized (queue = Trader.getDecisionQueue()) {
